...
namespace Calculator {
    ...
    static CalculatorReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "CQoBYRgBIAEoERIJCgFiGAIgASgRIh0KC1N1bVJlc3BvbnNlEg4KBnJlc3Vs",
            "dBgBIAEoESIxCh9QcmltZU51bWJlckRlY29tcG9zaXRpb25SZXF1ZXN0Eg4K",
            "Bm51bWJlchgBIAEoDSI4CiBQcmltZU51bWJlckRlY29tcG9zaXRpb25SZXNw",
            "b25zZRIUCgxwcmltZV9mYWN0b3IYASABKA0yyAEKEUNhbGN1bGF0b3JTZXJ2",
            "aWNlEjgKA1N1bRIWLmNhbGN1bGF0b3IuU3VtUmVxdWVzdBoXLmNhbGN1bGF0",
            "b3IuU3VtUmVzcG9uc2UiABJ5ChhQcmltZU51bWJlckRlY29tcG9zaXRpb24S",
            "Ky5jYWxjdWxhdG9yLlByaW1lTnVtYmVyRGVjb21wb3NpdGlvblJlcXVlc3Qa",
            "LC5jYWxjdWxhdG9yLlByaW1lTnVtYmVyRGVjb21wb3NpdGlvblJlc3BvbnNl",
            "IgAwAWIGcHJvdG8z"));
  ...
  public sealed partial class SumRequest : pb::IMessage<SumRequest> {
    ...
    public int CalculateSize() {
      int size = 0;
      if (A != 0) {
        size += 1 + pb::CodedOutputStream.ComputeSInt32Size(A);
      }
      if (B != 0) {
        size += 1 + pb::CodedOutputStream.ComputeSInt32Size(B);
      }
      if (_unknownFields != null) {
  ...
  public sealed partial class PrimeNumberDecompositionResponse : pb::IMessage<PrimeNumberDecompositionResponse> {
    ...
    private uint primeFactor_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public uint PrimeFactor {
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      if (PrimeFactor != 0) {
        output.WriteRawTag(8);
        output.WriteUInt32(PrimeFactor);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (PrimeFactor != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(PrimeFactor);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
